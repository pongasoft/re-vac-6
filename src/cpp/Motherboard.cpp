...
Motherboard::Motherboard(): fAudioOutput("/audio_outputs/audioOutputLeft", "/audio_outputs/audioOutputRight"),
                            fAudioInput("/audio_inputs/audioInputLeft", "/audio_inputs/audioInputRight"),
                            fPropArrayStart("/custom_properties/prop_array_start"),
                            fPropArraySize("/custom_properties/prop_array_size"),
                            fPropZoomLevel("/custom_properties/prop_zoom_level"),
                            fPropSoftClippingLevel("/custom_properties/prop_soft_clipping_level"),
                            fPropSoftClippingLevelDisplay("/custom_properties/prop_soft_clipping_level_display"),
                            fPropMaxLevelWindow1("/custom_properties/prop_max_level_window_1_value",
                                                 "/custom_properties/prop_max_level_window_1_state",
                                                 "/custom_properties/prop_max_level_window_1_size"),
                            fPropMaxLevelWindow2("/custom_properties/prop_max_level_window_2_value",
                                                 "/custom_properties/prop_max_level_window_2_state",
                                                 "/custom_properties/prop_max_level_window_2_size"),
                            fPropMaxLevelWindow3("/custom_properties/prop_max_level_window_3_value",
                                                 "/custom_properties/prop_max_level_window_3_state",
                                                 "/custom_properties/prop_max_level_window_3_size"),
                            fPropVolume1("/custom_properties/prop_volume_1"),
                            fPropVolume2("/custom_properties/prop_volume_2"),
                            fPropTotalVolume("/custom_properties/prop_total_volume"),
...
//  {
//    *fPropArray[i] = *rhs.fPropArray[i];
//  }

  fPropZoomLevel = rhs.fPropZoomLevel;
  fPropSoftClippingLevel = rhs.fPropSoftClippingLevel;

//  fPropVolume1 = rhs.fPropVolume1;
//  fPropVolume2 = rhs.fPropVolume2;
}

void Motherboard::registerForUpdate(IJBoxPropertyManager &manager)
{
  fPropTotalVolume.registerForInit(manager);

  fAudioOutput.registerForUpdate(manager);
  fAudioInput.registerForUpdate(manager);
  fPropOnOffBypass.registerForUpdate(manager);
  fPropZoomLevel.registerForUpdate(manager, PROP_ZOOM_LEVEL_TAG);
  fPropSoftClippingLevel.registerForUpdate(manager, PROP_SOFT_CLIPPING_LEVEL_TAG);
  fPropMaxLevelWindow1.registerForUpdate(manager, PROP_MAX_LEVEL_WINDOW_1_SIZE);
  fPropMaxLevelWindow2.registerForUpdate(manager, PROP_MAX_LEVEL_WINDOW_2_SIZE);
  fPropMaxLevelWindow3.registerForUpdate(manager, PROP_MAX_LEVEL_WINDOW_3_SIZE);
  fPropVolume1.registerForUpdate(manager, PROP_VOLUME_1);
  fPropVolume2.registerForUpdate(manager, PROP_VOLUME_2);
}
